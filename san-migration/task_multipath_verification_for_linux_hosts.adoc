...
---
= Multipath-Verifizierung für Linux Hosts
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Führen Sie die folgenden Schritte für Linux-Hosts durch.

.Schritt
. Führen Sie die folgenden Befehle aus, um zu überprüfen, ob DM-MP Multipath auf einem Linux-Host richtig konfiguriert und funktioniert:``multipath -ll``
+
[listing]
----
